...
<div class="overflow-x-auto dark:text-slate-400 ">
    <h1 class="my-6 text-2xl font-semibold">Your Archive User List</h1>
    @if (session('status'))
                    ...
                    <tr >
                        ...
                        <td class="flex gap-1">
                            ...
                            <div class="modal-box dark:bg-slate-700">
                                ...
                                <p class="py-4">Are you sure you want to restore this user?</p>
                                <div class="modal-action flex gap-4">
                                    <form action="/trash/user/{{ $data->id }}/restore" method="POST">
                                        @csrf
                                        @method('PUT')
                            ...
                            <div class="modal-box dark:bg-slate-700">
                                ...
                                <div class="modal-action flex gap-4">
                                    <form action="/trash/user/{{ $data->id }}/delete" method="POST">
                                        @csrf
